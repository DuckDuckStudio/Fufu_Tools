...
categories = {
    ...
    "自动化": {
        "自动左键连点": ".\\Tools\自动化\自动左键连点.py",
        "自动按键连按": ".\\Tools\自动化\自动按键连按.py",
    },
    "查找": {
    ...
    "[实验性工具]": {
        ...
        "自动打包py/pyw文件": ".\\Tools\\【实验性工具】\\自动化\\自动打包所有py文件\\使用Pyinstaller.py",
        "批量水印添加": ".\\Tools\\【实验性工具】\\图片处理\\批量水印.py",
        "[Warn]批量水印添加": ".\\Tools\\【实验性工具】\\图片处理\\Warn.txt",
        "视频音频提取": ".\\Tools\\【实验性工具】\\视频音频提取\\main.py",
